...
template <typename T1, typename T2>
template <typename U1, typename U2>
Pair<T1, T2>::Pair(const Pair<U1, U2>& other) : first(other.first),
                                                second(other.second)
{
}
...
template <typename T1, typename T2>
template <typename U1, typename U2>
Pair<T1, T2>::Pair(Pair<U1&, U2&>&& other) : first(other.first),
                                             second(other.second)
{
}
...
template <typename T1, typename T2>
template <typename U1, typename U2>
Pair<T1, T2>::Pair(Pair<U1, U2>&& other) : first(std::move(other.first)),
